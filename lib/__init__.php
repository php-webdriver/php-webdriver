...
require_once('exceptions/NoCollectionException.php');
require_once('exceptions/NoStringException.php');
require_once('exceptions/NoStringLengthException.php');
require_once('exceptions/NoStringWrapperException.php');
require_once('exceptions/NoSuchDriverException.php');
require_once('exceptions/NoSuchElementException.php');
require_once('exceptions/NoSuchFrameException.php');
require_once('exceptions/UnknownCommandException.php');
require_once('exceptions/StaleElementReferenceException.php');
require_once('exceptions/ElementNotVisibleException.php');
require_once('exceptions/InvalidElementStateException.php');
require_once('exceptions/UnknownServerException.php');
require_once('exceptions/ExpectedException.php');
require_once('exceptions/ElementNotSelectableException.php');
require_once('exceptions/NoSuchDocumentException.php');
require_once('exceptions/UnexpectedJavascriptException.php');
require_once('exceptions/NoScriptResultException.php');
require_once('exceptions/XPathLookupException.php');
require_once('exceptions/NoSuchCollectionException.php');
require_once('exceptions/TimeOutException.php');
require_once('exceptions/NullPointerException.php');
require_once('exceptions/NoSuchWindowException.php');
require_once('exceptions/InvalidCookieDomainException.php');
require_once('exceptions/UnableToSetCookieException.php');
require_once('exceptions/UnexpectedAlertOpenException.php');
require_once('exceptions/NoAlertOpenException.php');
require_once('exceptions/ScriptTimeoutException.php');
require_once('exceptions/InvalidCoordinatesException.php');
require_once('exceptions/IMENotAvailableException.php');
require_once('exceptions/IMEEngineActivationFailedException.php');
require_once('exceptions/InvalidSelectorException.php');
require_once('exceptions/SessionNotCreatedException.php');
require_once('exceptions/MoveTargetOutOfBoundsException.php');
