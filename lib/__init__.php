...
// exceptions
require_once('IndexOutOfBoundsException.php');
require_once('NoCollectionException.php');
require_once('NoStringException.php');
require_once('NoStringLengthException.php');
require_once('NoStringWrapperException.php');
require_once('NoSuchDriverException.php');
require_once('NoSuchElementException.php');
require_once('NoSuchFrameException.php');
require_once('UnknownCommandException.php');
require_once('StaleElementReferenceException.php');
require_once('ElementNotVisibleException.php');
require_once('InvalidElementStateException.php');
require_once('UnknownServerException.php');
require_once('ExpectedException.php');
require_once('ElementNotSelectableException.php');
require_once('NoSuchDocumentException.php');
require_once('UnexpectedJavascriptException.php');
require_once('NoScriptResultException.php');
require_once('XPathLookupException.php');
require_once('NoSuchCollectionException.php');
require_once('TimeOutException.php');
require_once('NullPointerException.php');
require_once('NoSuchWindowException.php');
require_once('InvalidCookieDomainException.php');
require_once('UnableToSetCookieException.php');
require_once('UnexpectedAlertOpenException.php');
require_once('NoAlertOpenException.php');
require_once('ScriptTimeoutException.php');
require_once('InvalidCoordinatesException.php');
require_once('IMENotAvailableException.php');
require_once('IMEEngineActivationFailedException.php');
require_once('InvalidSelectorException.php');
require_once('SessionNotCreatedException.php');
require_once('MoveTargetOutOfBoundsException.php');
